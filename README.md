...
Engaged in a prestigious CAS Actuarial Competition, showcasing practical skills and knowledge in the actuarial field. Demonstrated exceptional performance as part of a team, using R-Studio, Excel and more to create a pricing structure for a data set given by the University
            ...
            <li>
                Mercer Case Competition Committee:
Our joint efforts in organizing the Mercer Case Competition at the University of Texas not only elevate the event's prestige but also contribute significantly to sustaining the actuarial science field at UT Austin. By providing students with a unique opportunity to apply their skills to real-world challenges and engage directly with industry leaders like Mercer, we are nurturing a vibrant and dynamic actuarial community within the university. This not only enriches the educational experience but also ensures that UT remains a leading institution in producing future actuarial professionals who are well-equipped to shape the industry's future.
            </li>
